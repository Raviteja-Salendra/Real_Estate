...
export default function EditListing() {
   ...
   useEffect(()=>{
    const fetchListing = async()=>{
        const listingId = params.listingId; //(params.listingId is coming app.jsx url)
   ...
   <main className='p-3 max-w-4xl mx-auto'>
    ...
    <form onSubmit={submitHandler} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <button disabled={loading || uploading} className='p-3 bg-slate-600 text-white rounded-lg uppercase hover:opacity-80 disabled:opacity-70'>{loading ? 'Updating..': 'Edit Listing'}</button>
