  ...
  return (
    <div className='bg-white shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg w-full sm:w-[330px]'>
      ...
      <div className="p-3 flex flex-col gap-2 w-full">
        <p className='truncate  text-lg font-serif font-semibold text-slate-600'>{listing.name}</p>
        ...
        <p className='text-slate-500 mt-2 font-semibold flex items-center '>₹{listing.offer ? listing.discountPrice.toLocaleString('en-IN') : listing.regularPrice.toLocaleString('en-IN')}
